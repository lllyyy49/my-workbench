...
个人效率工具平台，包含待办事项管理、日程日历、快速记事、数据统计面板、每日工作日志、小红书笔记管理、商品评价库。
...
3. **小红书笔记 (Xiaohongshu)** - 笔记内容管理、商品链接、推广数据统计（浏览/点赞/评论/分享）
4. **评价库 (Reviews)** - 商品评价模板管理，自动识别文字/图片重复，一键复制评价和图片
5. **待办事项 (Todos)** - 增删改查、标记完成、编辑
6. **日程日历 (Calendar)** - 月视图日历、添加/删除日程、颜色标记
7. **快速记事 (Notes)** - 创建/编辑/删除笔记、搜索、自动保存
